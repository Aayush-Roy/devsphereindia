...
//             <motion.div
//               className="relative w-64 sm:w-72 lg:w-80 h-64 sm:h-72 lg:h-80 flex items-center justify-center"
//               initial={{ opacity: 0, scale: 0.8 }}
//               animate={{ opacity: 1, scale: 1 }}
//               transition={{ duration: 1, delay: 0.6 }}
//             >
//               {/* Main Token */}
//               <div className="absolute w-20 sm:w-24 lg:w-28 h-20 sm:h-24 lg:h-28 bg-gradient-to-r from-primary to-secondary rounded-2xl transform rotate-12 glow animate-pulse-slow"></div>

//               {/* Secondary Tokens */}
//               <div className="absolute top-6 sm:top-8 -right-4 sm:-right-6 w-14 sm:w-16 lg:w-20 h-14 sm:h-16 lg:h-20 bg-gradient-to-r from-secondary to-accent rounded-xl transform -rotate-12 glow-secondary animate-float"></div>
//               <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 w-12 sm:w-14 lg:w-16 h-12 sm:h-14 lg:h-16 bg-gradient-to-r from-accent to-primary rounded-lg transform rotate-45 opacity-80 animate-float-delayed"></div>

//               {/* Center Logo */}
//               <div className="absolute inset-0 flex items-center justify-center">
//                 <div className="w-14 sm:w-16 lg:w-20 h-14 sm:h-16 lg:h-20 bg-gradient-hero rounded-xl flex items-center justify-center shadow-2xl">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            ...
            >
              ...
              {/* Secondary Tokens */}
              <div className="absolute top-6 sm:top-8 -right-4 sm:-right-6 w-14 sm:w-16 lg:w-20 h-14 sm:h-16 lg:h-20 bg-gradient-to-r from-secondary to-accent rounded-full transform -rotate-12 glow-secondary animate-float"></div>
              <div className="absolute -bottom-4 sm:-bottom-6 -left-4 sm:-left-6 w-12 sm:w-14 lg:w-16 h-12 sm:h-14 lg:h-16 bg-gradient-to-r from-accent to-primary rounded-lg transform rotate-45 opacity-80 animate-float-delayed"></div>
